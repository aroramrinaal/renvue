import Chatbot from './get-started/page';
import Link from 'next/link';

export default function Home() {
  return (
    <div className="max-h-screen bg-[#010208] relative overflow-hidden">
      {/* Background effects */}
      ...
      {/* Main content */}
      <div className="relative flex flex-col min-h-screen mt-24 md:mt-0">
        {/* Text content at the top */}
        <div className="text-center pt-20 sm:pt-32 px-4 mb-24 md:mb-8 flex-1 flex flex-col justify-center">
          <h1 className="text-3xl md:text-2xl lg:text-4xl font-bold mb-8 md:mb-4">
        ...
        <div className="mt-auto">
          <img
            src="/image.png"
            alt="Map Image"
            className="w-full h-[60vh] sm:h-auto object-cover"
          />
        </div>
      </div>
    </div>
